...
- Um middleware que será utilizado em todas rotas que recebem o ID do projeto nos parâmetros da URL que verifica se o projeto com aquele ID existe. Se não existir retornará um erro, caso contrário permite a requisição para continuar normalmente;
